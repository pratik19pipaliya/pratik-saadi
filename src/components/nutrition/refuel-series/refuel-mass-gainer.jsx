...
const RefuelSeriesMassGainer = () => {
  ...
  const productImages = {
    "1kg-Chocolate": ["/assets/images/nutrition/refuel-muscle-matrix.webp"],
    "2kg-Chocolate": ["/assets/images/nutrition/refuel-muscle-matrix-1.webp"],
  };
                ...
                <div className="col-12 return-policy-main">
                  <div className="mt-3 editor-text">
                    ...
                    <div className="pb-2 mt-3 text-center ql-editor descriptionShow text-secondary">
                      ...
                      <Link
                        to="https://api.whatsapp.com/send?phone=7874331000&amp;text= Hello, I have an inquiry about Refuel 2.0 Mass Gainer Powder product."
                        type="button"
...
export default RefuelSeriesMassGainer;
