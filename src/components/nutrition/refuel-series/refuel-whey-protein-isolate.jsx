...
const RefuelSeriesWheyProteinIsolate = () => {
  ...
  const productImages = {
    ...
    "2kg-Chocolate": [
      "/assets/images/nutrition/refuel-isolate-chocobrownie-2kg.webp",
    ],
    "1kg-Mawa Kulfi": [
      "/assets/images/nutrition/refuel-isolate-mawa-kulfi.webp",
    ],
    "2kg-Mawa Kulfi": [
      "/assets/images/nutrition/refuel-isolate-mawa-kulfi-2kg.webp",
    ],
    "1kg-Mocha Coffee": [
      "/assets/images/nutrition/refuel-isolate-mocha-coffee.webp",
    ],
    "2kg-Mocha Coffee": [
      "/assets/images/nutrition/refuel-isolate-mocha-coffee-2kg.webp",
    ],
    "1kg-Mango": ["/assets/images/nutrition/refuel-isolate-mango.webp"],
    "2kg-Mango": ["/assets/images/nutrition/refuel-isolate-mango-2kg.webp"],
  };
