...
const RefuelSeriesWheyProtein = () => {
  ...
  const productImages = {
    "1kg-Chocolate": ["/assets/images/nutrition/refuel-protein-chocolate.webp"],
    "2kg-Chocolate": [
      "/assets/images/nutrition/refuel-protein-chocolate-2kg.webp",
    ],
    "1kg-Mawa Kulfi": [
      "/assets/images/nutrition/refuel-protein-mawa-kulfi.webp",
    ],
    "2kg-Mawa Kulfi": [
      "/assets/images/nutrition/refuel-protein-mawa-kulfi-2kg.webp",
    ],
    "1kg-Mocha Coffee": [
      "/assets/images/nutrition/refuel-protein-mocha-coffee.webp",
    ],
    "2kg-Mocha Coffee": [
      "/assets/images/nutrition/refuel-protein-mocha-coffee-2kg.webp",
    ],
    "1kg-Mango": ["/assets/images/nutrition/refuel-protein-mango.webp"],
    "2kg-Mango": ["/assets/images/nutrition/refuel-protein-mango-2kg.webp"],
  };
            ...
            <div className="col-lg-12 px-md-3 mb-2 mt-2 mt-md-0 order-1">
              ...
              <div className="row">
                <div className="col-12">
                  <h2 className="f-rob-bol text-center f-35">Whey Protein</h2>
                </div>
                <br />
                <div className="col-12 return-policy-main">
                  <div className="mt-3 editor-text">
                    ...
                    <div className="pb-2 mt-3 text-center ql-editor descriptionShow text-secondary">
                      ...
                      <Link
                        to="https://api.whatsapp.com/send?phone=7874331000&amp;text= Hello, I have an inquiry about Refuel 2.0 Whey Protein product."
                        type="button"
...
export default RefuelSeriesWheyProtein;
