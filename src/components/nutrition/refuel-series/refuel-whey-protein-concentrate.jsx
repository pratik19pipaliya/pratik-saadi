...
const RefuelSeriesWheyProteinConcentrate = () => {
  ...
  const productImages = {
    "1kg-Chocolate": [
      "/assets/images/nutrition/refuel-concentrate-chocolate.webp",
    ],
    "2kg-Chocolate": [
      "/assets/images/nutrition/refuel-concentrate-chocolate-2kg.webp",
    ],
    "1kg-Mawa Kulfi": [
      "/assets/images/nutrition/refuel-concentrate-mawa-kulfi.webp",
    ],
    "2kg-Mawa Kulfi": [
      "/assets/images/nutrition/refuel-concentrate-mawa-kulfi-2kg.webp",
    ],
    "1kg-Mocha Coffee": [
      "/assets/images/nutrition/refuel-concentrate-mocha-coffee.webp",
    ],
    "2kg-Mocha Coffee": [
      "/assets/images/nutrition/refuel-concentrate-mocha-coffee-2kg.webp",
    ],
    "1kg-Mango": ["/assets/images/nutrition/refuel-concentrate-mango.webp"],
    "2kg-Mango": ["/assets/images/nutrition/refuel-concentrate-mango-2kg.webp"],
  };
                ...
                <div className="col-12 return-policy-main">
                  <div className="mt-3 editor-text">
                    ...
                    <div className="pb-2 mt-3 text-center ql-editor descriptionShow text-secondary">
                      ...
                      <Link
                        to="https://api.whatsapp.com/send?phone=7874331000&amp;text= Hello, I have an inquiry about Refuel 2.0 Whey Protein Concentrate product."
                        type="button"
...
export default RefuelSeriesWheyProteinConcentrate;
