...
function GomziNutritionBuy2MassGainer() {
  ...
  const product = [
    "/assets/images/nutrition/gomzi-nutrition-buy-2-mass-gainer-1.webp",
  ...
  return (
    <>
      <PageMeta
        title="Fuel workouts with our Mass Gainer and Creatine. Free Shaker included"
        description="Boost your workout with Muscle Matrix Mass Gainer in Chocolate flavor, featuring Lemon-flavored Creatine. Enjoy a free shaker with every purchase."
      ...
      <WhatsappHeaderApp
        message={
          "Hello, I wanted to know more about Mass Gainer and Creatine Combo. "
        }
      ...
      <div className="main-content margintop-nutrition">
        <section className="product-detail-main bg-white">
          ...
          <div className="rating-review-section mt-3 bg-secondaryyyy px-3 px-md-5 w-100">
            <NutritionReviewSection product_id="66a22f361e55f03e92d535b0" />
          </div>
          <CertifiedProduct />
          <MoreProducts />
        </section>
...
export default GomziNutritionBuy2MassGainer;
