...
function GomziNutritionBuy3Combo() {
  ...
  const product = [
    "/assets/images/nutrition/gomzi-nutrition-buy-3-combo-1.webp",
  ...
  return (
    <>
      <PageMeta
        title="250g Ignite, Creatine, EEA & Free Shaker | Premium Nutrition
          Supplement"
        description="Get 250g Ignite, Creatine, EEA & a free shaker! Boost your nutrition with protein, collagen, and pre-gym supplements. Enhance your fitness journey today."
      ...
      <WhatsappHeaderApp
        message={
          "Hello, I wanted to know more about Ignite, Creatine, EEA & Free Shaker Combo. "
        }
      ...
      <div className="main-content margintop-nutrition">
        <section className="product-detail-main bg-white">
          ...
          <div className="rating-review-section mt-3 bg-secondaryyyy px-3 px-md-5 w-100">
            <NutritionReviewSection product_id="66a22fc01e55f03e92d535e2" />
          </div>
          <CertifiedProduct />
          <MoreProducts />
        </section>
...
export default GomziNutritionBuy3Combo;
