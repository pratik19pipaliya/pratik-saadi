...
function GomziNutritionMuscleBuildCombo() {
      ...
      <div className="main-content margintop-nutrition">
        <section className="product-detail-main bg-white">
                  ...
                  <div className="row">
                    ...
                    <div className="col-9 pt-2">
                      <div className="d-inline-block">
                        ...
                        <p className="f-20">
                          MRP:-
                          <span className="price--line-through">₹2,999/-</span>
                        </p>
                      </div>
                    </div>
                      ...
                      >
                        <div className="descriptionShow text-secondary">
                          ...
                          <p className="mb-2">
                            ...
                            indulge in creatine intake. Creatine should be used
                            cautiously before or during activities that require
                            motor coordination, like driving.
                          </p>
                          <p className="mb-2">
          ...
          <div className="rating-review-section mt-3 bg-secondaryyyy px-3 px-md-5 w-100">
            <NutritionReviewSection product_id="6616357847003e22aea8a0fe" />
          </div>
          <CertifiedProduct />
          <MoreProducts />
        </section>
...
export default GomziNutritionMuscleBuildCombo;
