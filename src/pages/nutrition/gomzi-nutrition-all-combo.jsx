...
function GomziNutritionAllCombo() {
  ...
  const product = [
    ...
    "/assets/images/nutrition/all-product-combo-2.webp",
    "/assets/images/nutrition/all-product-combo-3.webp",
    "/assets/images/nutrition/all-product-combo-4.webp",
  ];
  ...
  return (
    <>
      <PageMeta
        title="Gomzi Nutrition All Combo - Complete Nutrition Stack for Health &
          Fitness"
        description="Get the ultimate health and fitness support with Gomzi Nutrition All Combo. A complete supplement stack designed for muscle building, fat loss, and overall wellness."
        keywords="All Combo, complete nutrition stack, health and fitness supplements, muscle and fat combo, buy fitness supplements, overall wellness stack"
      ...
      <div className="main-content margintop-nutrition">
        <section className="product-detail-main bg-white">
                ...
                <div className="col-12 p-0 col-lg-5 mb-3 mt-3 mb-lg-0 product-detail-right">
                  <div className="row">
                    <div className="col-12 mt-3 d-block d-lg-none">
                      <p className="f-rob-bol f-18">Combo</p>
                          ...
                          <div className="avail-in-other-size-main">
                            <div className="d-block avail-in-other-size active">
                              <span className="d-block product-type avail-other-size cp active">
                                <p className="d-block m-0">Pack of 8</p>
                              </span>
                            </div>
                          </div>
                        </li>
                      ...
                      <ul className="list-unstyled mb-0">
                        <li className="mr-3 mb-3 d-inline-block">
                          <div className="avail-in-other-size-main">
                            <div className="d-block avail-in-other-size active">
                              <span className="d-block product-type avail-other-size cp active">
                                <p className="d-block m-0">Pack Of 7</p>
                              </span>
                            </div>
                          </div>
                        </li>
                      ...
                      >
                        <div className="descriptionShow text-secondary">
                          ...
                          <p className="mb-3">
                            ...
                            premium source of protein powders. Each serving
                            delivers an excellent course of naturally occurring
                            essential amino acids and Branch Chain Amino Acids
                            (BCAA's). The protein found in Performance Whey
                            Blend help support the growth and maintenance of
                            lean muscle mass, ideal for everyone.
                          </p>
                          <p>
                          ...
                          <p>
                            <strong>ATP Creatine Monohydrate</strong>
                          </p>
                          <p className="mb-3">
                          ...
                          <p>
                            <strong>Ignite Fat Burner</strong>
                          </p>
                          <p className="mb-3">
          ...
          />
          <HappyClientReview />
          <div className="rating-review-section mt-3 bg-secondaryyyy px-3 mx-auto mb-4 px-md-5 w-80">
            <NutritionReviewSection product_id="667bb4d375e450a0b5a523c7" />
          </div>
          <CertifiedProduct />
          <MoreProducts />
        </section>
...
export default GomziNutritionAllCombo;
